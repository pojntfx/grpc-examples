...
class MatherStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Add = channel.unary_unary(
                '/com.pojtinger.felicitas.grpcExamples.gomather.Mather/Add',
...
def add_MatherServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'com.pojtinger.felicitas.grpcExamples.gomather.Mather', rpc_method_handlers)
...
class Mather(object):
    ...
    def Add(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/com.pojtinger.felicitas.grpcExamples.gomather.Mather/Add',
